...
{
    public class FindMyNotificationsQuery : SearchQuery<Notification>
    {
        public Guid UserId { get; set; }

        public FindMyNotificationsQuery()
        {
            PageNo = 1;
            PageSize = 10;
        ...
        public ISpecification<Notification> ToSpec(Guid userId)
        {
            UserId = userId;
            return ToSpec();
        }
        ...
        public override ISpecification<Notification> ToSpec()
        {
            ...
            ISpecification<Notification> spec = new Specification<Notification>(o => o.IsPublic || o.Recipients.Any(r => r.Id == UserId) || o.Sender.Id == UserId);
