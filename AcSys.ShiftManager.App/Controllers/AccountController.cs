...
using AcSys.ShiftManager.App.Models;
...
namespace AcSys.ShiftManager.App.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            // https://github.com/DotNet4Neo4j/Neo4j.AspNet.Identity/issues/1
            ...
            if (user != null)
            {
                await this.SignInManager.SignInAsync(user, model.RememberMe, model.RememberMe);
                return RedirectToLocal(returnUrl);
            }
            else
            {
